...
<head>
    ...
    <style>
        ...
        .main-text {
            color: rgb(11, 41, 70); text-align: center;
            font-weight: 700;
            font-size: 16;
            margin-top: 15px;
        }
        ...
        <tbody style='color:rgb(0, 0, 0)'>
            ...
            <tr>
                <td style='padding: 20px;'>
                    ...
                    <h1 style='text-align: center; font-size: 22px; color: rgb(11, 41, 70);'> Password Reset. </h1>
                    <hr />
                    <section style='text-align: center;'>
                        <p> Hello User,</p>
                        <p>
                           We have just recived a request inorder to reset your password. Please click on the button below to reset your password.
                        </p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <h3 style='color: rgb(11, 41, 70); text-align: center; font-weight: 700; margin-top: 0px; padding-top: 0px; font-size: 18px;'> Account Details:  </h3>
                    ...
                    <div style='text-align: center;'>
                        ...
                        <h4 style='color: rgb(11, 41, 70); text-align: center; font-weight: 700; font-size: 20px;'>
