<!--
    ...
    @purpose: This is the contact page for the website.
...
<body style='background-color: rgba(204, 204, 204, 0.079);'>


    <h1 style='color: rgb(11, 41, 70);  text-align: center; margin-top: 15px;'> Cloud Chef </h1>
        ...
        <tbody style='color:rgb(0, 0, 0)'>
            ...
            <tr>
                <td style='padding: 20px;'>
                    ...
                    <h1 style='text-align: center; font-size: 22px; color: rgb(11, 41, 70);'> A User has requested a service inquiry. </h1>
                    <hr />
                    <section style='text-align: center;'>
                        <p> Hello Admin,</p>
                        <p>
                            We have just received a request from a user for a service inquiry  for the following service:     <b> Corporate  Plans </b>
                        </p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <h3 style='color: rgb(11, 41, 70); text-align: center; font-weight: 700;'>
                        Contact Information
                    </h3>
                ...
                <td>
                    <div style='padding: 20px; text-align: center;'>
                        <p style='text-align: center;'>
                            <a href='https://www.cloudchef.ca/' style='color: rgb(16, 30, 100);'> Cloud Chef </a>
                        </p>
