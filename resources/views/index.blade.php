...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="Cloud chef, Employee management solution, recipe management solution" />
    <meta name="author" content="Cloud chef" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- cache control  for all images, css, and js !-->
    ...
    <!-- enable cache for the images and assets  !-->
