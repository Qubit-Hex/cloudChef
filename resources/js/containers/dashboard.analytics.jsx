...
export const DashboardAnalytics = (props) => {
    ...
    return (
        <div className="container-fluid profile_card dashboard-content">
            ...
            <h2 className='ml-4'> <b>Analytics </b> <small className='sub-caption ' > Welcome ()
            <br /><span className='text-center'>View and track your stores performance </span> </small></h2><br/>
            ...
            <div className="row">
                <div className='col'>
                     <img src='/img/SVG/data_analytics.svg' width={400} height={400} className='img-fluid mx-auto d-block' />
                </div>
            </div>
            ...
            <div className='row'>
                 ...
                 */}
                <div className='col'>
                    <h2 className='text-center'> <b>Current Store Sales</b> </h2>
                    {/** DISPLAY THE CURRENT DATE    */}
                    <div className='row'>
                        <div className='col'>
                            <h5 className='text-center'> <b>Today</b> { Date().toString()   } </h5>
                            <h5 className='text-center'> <b> Sales</b> $ {5000}</h5>
                        </div>
                    </div>
...
<Chart
  chartType="Bar"
  data={[["Period", "Cost"], ['Jan', 3000], ['Feb', 10000], ['Mar', 15000], ['Apr', 18000], ['May', 21000], ['Jun', 14000]]}
  width="100%"
  height="400px"
/>
                ...
                <div className='col-sm'>
                    <div className='card'>
                        <div className='card-body'>
                            ...
                            <Chart
                            chartType="Bar"
                            data={[["Period", "Cost"], ['Jan', 5000], ['Feb', 7000], ['Mar', 10000], ['Apr', 12000], ['May', 9000], ['Jun', 15000]]}
                            width="100%"
                            height="400px"
                            />

                            <p className='card-text' style={{fontWeight: 700}}>  View Detailed labour report.</p>
...
<Chart
  chartType="Bar"
  data={[["Period", "Sales"], ['Jan', 20000], ['Feb', 30000], ['Mar', 25000], ['Apr', 10000], ['May', 40000], ['Jun', 50000]]}
  width="100%"
  height="400px"
/>
