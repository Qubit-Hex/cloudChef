        ...
        <div className='container header-section-space-md mb-4'>
            ...
            <div className='row'>
                ...
                <div className='col-sm header-section-space-md'>
                        <h1  className='header-subtitle'> AUTOMATE OUTDATED PROCCESSES </h1>
                        <h2 className='header-title'> Work Smarter, not Harder! </h2>
            ...
            <div className='row header-section-space-md'>
                ...
                <div className='col-sm header-section-space-md'>
                    <section>
                        <h1 className='header-subtitle'> ANYWHERE ANYTIME </h1>
                        <h2 className='header-title'> No Matter Where Life Takes You</h2>
                        <p className='header-description'>
            ...
            <div className='row header-section-space-md'>
                ...
                <div className='col-sm header-section-space-md'>
                    <h1 className='header-subtitle'> Data-Driven Business Insights</h1>
                    <h2 className='header-title'> Putting Your Data to Good Use</h2>
                    <p className='header-description'>  
            ...
            <div className='row header-section-space-md'>
                ...
                <div className='col-sm header-section-space-md'>
                    <h1 className='header-subtitle'>   REAL TIME COMMINICATION </h1>
                    <h2 className='header-title'> Instant Data in your organisation</h2>
