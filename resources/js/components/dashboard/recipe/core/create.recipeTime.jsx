            ...
            <div className="modal-dialog">
                ...
                <div class="modal-body"
                    ...
                    <h1 className='header-subtitle text-center'>
                        How long does your recipe take?
                    </h1>
                    <div className='row'>
                    ...
                    <div className='row m-4 mx-auto d-flex'>
                        <div className='col-md-6'>
                            ...
                            <button type='button' className='btn header-action w-75'
                                onClick={
                                    (e) => {
                                        // go back to the last form
                                        let container = document.getElementById("modal-container");
                                        return ReactDOM.render (
                                            <CreateNutritionalFacts recipeIngredients={
                                ...
                                onClick={
                                    (e) => {
                                        ...
                                        if (inputValidationState.includes(false)) {
                                            ...
                                            return ReactDOM.render (
                                                <CreateInstructions recipeIngredients={
                                                        props.recipeIngredients
                                                    }
                                                    recipeSummary={
                                                        props.recipeSummary
