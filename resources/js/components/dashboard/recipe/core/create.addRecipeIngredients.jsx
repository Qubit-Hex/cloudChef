...
export const AddRecipeIngredients = (props) => {
    ...
    const handleNutritionalFacts = () => {
        ...
        if (ingredient.length === 0) {
            ...
            return ReactDOM.render (
                <CreateNutritionalFacts recipeSummary={
                        props.recipeSummary
                    }
            ...
            <div className="modal-dialog">
                <div class="modal-content w-75">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-transparent modal-close far fa-times-circle" aria-label="Close"
                            onClick={
                                (e) => {
                                    e.preventDefault();
                                    closeWindow();
                ...
                <div class="modal-body d-flex"
                    ...
                    <div className='container'>
                        <div className="row">
                            <div className="col">
                                <h4 className='header-subtitle text-center'>
                                    Ingredients
                                </h4>
                                <div className="form-group">
                                    <div className='col-md-10 mx-auto d-block'>
                                        <div id='modal-alert-container'></div>
                                        <label htmlFor="recipe-ingredents">Add Ingredient
                                        </label>
                                        <small className='text-muted'>
                                            Example: 6oz of demi glaze.
                                        </small>
                                        ...
                                        <button className='btn btn-message mt-2 mx-auto d-block w-auto'
                                            onClick={
                                                (e) => {
                        ...
                        <div className='row mt-4'>
                            ...
                            checkLength(ingredient) ? (
                                <div>
                                    <h3 className='header-subtitle text-center'>Ingredient List
                                    </h3>
                                            ...
                                            ingredient.map((item, index) => {
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        <td> {item} </td>
                                                        <td>
                                                            <button className='btn btn-danger mx-auto d-block w-auto'
                                                                data-key={index}
                                                                onClick={
